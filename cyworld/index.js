const menuHome = () => {
    ...
    document.getElementById("menuJukebox").style = "color: white; background-color: #298ed5;"
    document.getElementById("menuGame").style = "color: white; background-color: #298ed5;"
}
...
const menuJukebox = () => {
    ...
    document.getElementById("menuHome").style = "color: white; background-color: #298ed5;"
    document.getElementById("menuGame").style = "color: white; background-color: #298ed5;"
}
